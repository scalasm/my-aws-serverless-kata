...
const stackPrefix = "serverless-kata";
...
export class NetworkStack extends cdk.NestedStack {
  ...
  constructor(
    ...
    this.vpc = new ec2.Vpc(this, "vpc", {
      ipAddresses: ec2.IpAddresses.cidr("10.11.0.0/16"),
    ...
    // TODO Add stage too
    cdk.Aspects.of(this.vpc).add(new cdk.Tag("Name", `${stackPrefix}-vpc`));
    this._tagSubnets(
      this.vpc.privateSubnets,
      "Name",
      `${stackPrefix}-private-subnet`
    );
